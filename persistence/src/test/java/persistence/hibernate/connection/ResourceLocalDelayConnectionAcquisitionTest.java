package persistence.hibernate.connection;
...
import static persistence.util.ConcurrencyUtils.sleep;

@Slf4j
class ResourceLocalDelayConnectionAcquisitionTest extends AbstractPostgreSQLIntegrationTest {
    ...
    private void importForecasts() {
        doInJPA(entityManager -> {
            ...
            for (int i = 0; i < parseCount; i++) {
                Document forecastXmlDocument = readXmlDocument("data/weather.xml");
