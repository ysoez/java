...
class ArraysTest {
    ...
    class ValidSubsequence {
        ...
        static Stream<Arguments> happyPath() {
            return Stream.of(
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{5, 1, 22, 25, 6, -1, 8, 10}, new int[]{1, 6, -1, 10}, true),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{1, 2, 3}, new int[]{1, 2, 3}, true),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{1, 2, 3}, new int[]{2}, true),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{1, 2, 3}, new int[]{4}, false),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{1, 2, 3}, new int[]{3, 2}, false),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{1, 2}, new int[]{1, 2, 3}, false),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{}, new int[]{}, true),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{1, 2, 3}, new int[]{}, true),
                    arguments(new Arrays.ValidSubsequence.WhileLoop(), new int[]{}, new int[]{1}, false),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{5, 1, 22, 25, 6, -1, 8, 10}, new int[]{1, 6, -1, 10}, true),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{1, 2, 3}, new int[]{1, 2, 3}, true),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{1, 2, 3}, new int[]{2}, true),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{1, 2, 3}, new int[]{4}, false),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{1, 2, 3}, new int[]{3, 2}, false),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{1, 2}, new int[]{1, 2, 3}, false),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{}, new int[]{}, true),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{1, 2, 3}, new int[]{}, true),
                    arguments(new Arrays.ValidSubsequence.ForLoop(), new int[]{}, new int[]{1}, false)
            );
        }
