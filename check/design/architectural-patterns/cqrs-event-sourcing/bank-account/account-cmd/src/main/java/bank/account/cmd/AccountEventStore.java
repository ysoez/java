...
import bank.account.cmd.domain.EventStoreRepository;
import bank.es.event.AbstractEvent;
import bank.account.cmd.domain.EventModel;
...
import bank.cqrs.query.exception.ConcurrencyException;
...
public class AccountEventStore implements EventStore {
    ...
    @Override
    public void saveEvents(String aggregateId, Iterable<AbstractEvent> events, int expectedVersion) {
    ...
    @Override
    public List<AbstractEvent> getEvents(String aggregateId) {
        var eventStream = eventStoreRepository.findByAggregateIdentifier(aggregateId);
